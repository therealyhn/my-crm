const STYLES = {
  ...
  ghost:
    'inline-flex items-center justify-center rounded-sm border border-slate-300 bg-black/10 px-3 py-1.5 text-sm font-medium text-slate-700 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-70',
  danger:
